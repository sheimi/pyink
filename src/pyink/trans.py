...
from pyink.brackets import BracketMatchError
...
class BaseStringSplitter(StringTransformer):
    ...
    @staticmethod
    def _prefer_paren_wrap_match(LL: List[Leaf], is_pyink: bool) -> Optional[int]:
        """
        Returns:
        ...
        if is_pyink:
            # See https://github.com/psf/black/issues/3292.
            matching_nodes.append(syms.arglist)
...
class StringSplitter(BaseStringSplitter, CustomSplitMapMixin):
    ...
    def do_splitter_match(self, line: Line) -> TMatchResult:
        ...
        if self._prefer_paren_wrap_match(LL, line.mode.is_pyink) is not None:
...
class StringParenWrapper(BaseStringSplitter, CustomSplitMapMixin):
    ...
    def do_splitter_match(self, line: Line) -> TMatchResult:
        ...
        string_idx = (
            ...
            or self._prefer_paren_wrap_match(LL, line.mode.is_pyink)
        )
